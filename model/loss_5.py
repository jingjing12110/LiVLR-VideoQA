...
class MultipleChoiceLoss(nn.Module):
    ...
    def forward(self, score, target):
        ...
        # print(N,C)
        for b in range(N):
            # loop over incorrect answer,
            # check if correct answer's score larger than a margin
            c0 = target[b]
            for c in range(C):
                if c == c0:
                    continue

                # right class and wrong class should have score difference
                # larger than a margin
